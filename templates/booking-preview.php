...
<div class="tpc-booking-preview"
	...
	<div class="tpc-booking-header">
		<h3 class="tpc-booking-title">
			<?php esc_html_e( '旅行内容選択', 'andw-tour-price' ); ?>
		</h3>
		<p class="tpc-booking-subtitle">
			<?php esc_html_e( '下記内容を確認・変更し、申込フォームへお進みください', 'andw-tour-price' ); ?>
		</p>
	</div>
	...
	<form class="tpc-booking-form" id="tpc-booking-form">
		...
		<div class="tpc-booking-section tpc-selected-info">
			<h4 class="tpc-section-title"><?php esc_html_e( '選択済み情報', 'andw-tour-price' ); ?></h4>
			
			<div class="tpc-info-grid">
				<div class="tpc-info-item">
					<label><?php esc_html_e( '旅行日付', 'andw-tour-price' ); ?></label>
				...
				<div class="tpc-info-item">
					<label><?php esc_html_e( 'シーズン', 'andw-tour-price' ); ?></label>
					<div class="tpc-info-value">
		...
		<div class="tpc-booking-section tpc-duration-section">
			<h4 class="tpc-section-title"><?php esc_html_e( '日数選択', 'andw-tour-price' ); ?></h4>
		...
		<div class="tpc-booking-section tpc-departure-section">
			<h4 class="tpc-section-title"><?php esc_html_e( '出発地・帰着地', 'andw-tour-price' ); ?></h4>
		...
		<div class="tpc-booking-section tpc-pax-section">
			<h4 class="tpc-section-title"><?php esc_html_e( '人数（ご本人含む）', 'andw-tour-price' ); ?></h4>
				...
				<select name="pax" class="tpc-pax-input" data-tpc-pax>
					<?php for ( $i = 1; $i <= 6; $i++ ) : ?>
						<option value="<?php echo esc_attr( $i ); ?>" <?php selected( $i, $pax ); ?>>
							<?php printf( esc_html__( '%d名', 'andw-tour-price' ), $i ); ?>
						</option>
					<?php endfor; ?>
				</select>
			</div>
			...
			<?php if ( $pax === 1 ) : ?>
				<p class="tpc-pax-notice">
					<small><?php esc_html_e( 'お一人様参加の場合は追加料金が発生します', 'andw-tour-price' ); ?></small>
				</p>
			<?php endif; ?>
		</div>
		...
		<div class="tpc-booking-section tpc-options-section">
			<h4 class="tpc-section-title"><?php esc_html_e( 'オプション', 'andw-tour-price' ); ?></h4>
		...
		<div class="tpc-booking-section tpc-pricing-section">
			...
			<div class="tpc-pricing-breakdown" id="tpc-pricing-breakdown">
				...
				<div class="tpc-price-row" id="tpc-solo-fee-row" style="display: <?php echo $pax === 1 ? 'flex' : 'none'; ?>;">
					<span class="tpc-price-label">
						<?php esc_html_e( 'お一人様参加料金', 'andw-tour-price' ); ?>
					</span>
				...
				<div class="tpc-price-row" id="tpc-option-total-row" style="display: <?php echo $price_calculation['option_total'] > 0 ? 'flex' : 'none'; ?>;">
					<span class="tpc-price-label">
						<?php esc_html_e( 'オプション料金', 'andw-tour-price' ); ?>
					</span>
				...
				<div class="tpc-price-row tpc-total-row">
					<span class="tpc-price-label">
						<?php esc_html_e( '合計金額', 'andw-tour-price' ); ?>
					</span>
			...
			<p class="tpc-pricing-note">
				<small><?php esc_html_e( '※ 概算金額です。正確な料金は申込フォームで確認いただけます。', 'andw-tour-price' ); ?></small>
			</p>
		</div>
		...
		<div class="tpc-booking-section tpc-submit-section">
			<button type="submit" class="tpc-submit-btn">
				<span class="tpc-submit-text"><?php esc_html_e( '申込フォームへ', 'andw-tour-price' ); ?></span>
				<span class="tpc-submit-arrow">→</span>
			</button>
			
			<p class="tpc-submit-note">
				<small><?php esc_html_e( '次の画面で詳細情報をご入力いただきます', 'andw-tour-price' ); ?></small>
			</p>
		</div>
